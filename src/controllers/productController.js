...
const getAllProducts = async (req, res) => {
	const response = {...constants.defaultResponse};
	try {
		const request = await productService.getAllProducts(req.query);
		response.status = 200;
...
const getProductById = async (req, res) => {
	const response = {...constants.defaultResponse};
	try {
		const request = await productService.getProductById(req.params);
		response.status = 200;
		response.message = constants.product.PRODUCT_FETCHED;
		response.body = request;
	} catch (err) {
...
const updateProductById = async (req, res) => {
	const response = {...constants.defaultResponse};
	try {
		const request = await productService.updateProductById({
			id: req.params.id,
...
const deleteProduct = async (req, res) => {
	const response = {...constants.defaultResponse};
	try {
		const request = await productService.deleteProduct(req.params);
		response.status = 200;
